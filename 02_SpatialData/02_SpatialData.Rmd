---
title: "Importer et visualiser des données spatiales"
...
- Définir son environnement de travail en localisant son projet permet d'accéder facilement aux dossiers et sous-dossiers dans lequel se trouve les données à analyser

- Lorsque qu'on ouvre un chemin d'accès en utilisant les guillements "", il suffit d'appuyer sur la touche TAB pour accéder à un menu déroulant.
...
- Pour exporer les modalités d'une variable qualitative, on peut par exemple stocker le résultat de la fonction _table()_ dans un _data.frame_
